...
class TestDataGenerator:
    ...
    @staticmethod
    def create_test_turtle_data(
        turtle_id: str = "turtle_test", name: str = "Test Turtle"
    ) -> TurtleData:
            ...
            genetics={
                ...
                "pattern_color": GeneTrait(
                    ...
                    mutation_details=MutationDetails(
                        type="adaptive", similarity_to_parents=0.3
                    ),
                ),
    ...
    @staticmethod
    def create_test_preference_data(
...
class DataValidatorTester:
    ...
    def test_all_valid_data(self) -> Dict[str, bool]:
        ...
        results["preference_data"] = self.validator.validate_preference_data(pref_dict)[
            0
        ]
