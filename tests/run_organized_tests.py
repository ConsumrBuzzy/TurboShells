#!/usr/bin/env python3
"""
Organized test runner for TurboShells test suite
Runs unit tests, integration tests, and performance tests separately.
"""
...
def run_test_suite(test_path, suite_name, coverage=True):
    ...
    if coverage and "unit" in str(test_path):
...
def main():
    """Main test runner"""
    print("🚀 TURBOSHELLS ORGANIZED TEST RUNNER")
    print("=" * 60)
