...
class GraphicsManager:
    ...
    def load_settings(self) -> None:
        ...
        self.logger.info(f"Loaded graphics settings: {self.current_settings.resolution_width}x{self.current_settings.resolution_height}")
    ...
    def initialize_display(self) -> pygame.Surface:
        ...
        try:
            ...
            self.logger.info(f"Display initialized: {self.current_settings.get_resolution()}, Fullscreen: {self.current_settings.fullscreen}")
            return self.screen
