...
class AudioManager:
    ...
    def load_settings(self) -> None:
        ...
        self.logger.info(f"Loaded audio settings: Master Volume {self.current_settings.master_volume}, Enabled {self.current_settings.enabled}")
    ...
    def apply_volume_settings(self) -> None:
        ...
        try:
            ...
            self.logger.debug(f"Applied volume settings - Music: {master_volume:.2f}, SFX: {self.current_settings.get_sfx_volume():.2f}")
