"""Integration Test for Thorpy UI System

Verifies that the Thorpy-based UI Manager and Panels initialize and render correctly.
"""
...
def main():
    ...
    pygame.display.set_caption("Thorpy Integration Test")
    ...
    while running:
        ...
        # Render UI
        ui_manager.render_ui_panels(game_state)
        
        # Manual Thorpy Update/Draw if UIManager doesn't fully handle it yet
        if ui_manager.root_element:
            ui_manager.root_element.blit()
            ui_manager.root_element.update()
